...
class ParkingDataLoader(ABC):
    ...
    def cluster_zones(self, raw_zones: List[ParkingZoneInput]) -> List[ParkingZoneInput]:
        """
    ...
    def export_results_to_csv(
        self,
        original_zones: List[ParkingZoneInput],
        ...
        Args:
            original_zones: List of original ParkingZoneInput objects before optimization
