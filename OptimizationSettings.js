...
export default function OptimizationSettings() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(BASE_URL + '/optimize_elasticity', document.querySelector('settings-form'), {
                headers: {
            ...
            console.error("Failed to post optimization settings", error);
        }
    };
    ...
    return(
        <div>
            <form id="settings-form" onSubmit={handleSubmit}>
                ...
                <label htmlFor="submit-btn">Start </label>
