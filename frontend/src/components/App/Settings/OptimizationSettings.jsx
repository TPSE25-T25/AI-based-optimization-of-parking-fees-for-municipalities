...
const INITIAL_SETTINGS = {
  common: {
    ...
    clusteringRadiusM: 200.0,
    tariffs: { //Hidden from the users only configurable per Import/Export 
  ...
  agent: {
    driversPerZoneCapacity: 1.5,
    simulationRuns: 1,
    driverFeeWeight: 2.0,
    driverDistanceToLotWeight: 0.5,
    driverWalkingDistanceWeight: 0.5,
    driverAvailabilityWeight: 1.0,
  },
};
    ...
    <div className="configuration-panel">
      <form className="configuration-form">
        <div className="configuration-inputs">
          ...
          {renderInputGroup(
            'Clustering Radius (m)',
            'Maximum distance in meters between two zones to be grouped in the same pricing cluster',
            settings.common.clusteringRadiusM,
            (v) => updateSetting('common', 'clusteringRadiusM', Number(v)),
